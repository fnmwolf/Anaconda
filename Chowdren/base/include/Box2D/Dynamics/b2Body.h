...
public:
	...
	bool IsTouching(b2Body* other);
	bool IsTouching(b2Body* other, b2ContactResult* result);
	bool IsTouching(b2Shape* otherShape);
	bool IsTouching(b2Shape* otherShape, b2ContactResult* result);
	bool IsTouching(int collType);
	...
	/// Get the list of all contacts currently associated with this body
	...
	void SetUserData(bodyUserData data);

	/// Get the parent world of this body.
	b2World* GetWorld();

	inline float32 GetLinearDamping();
	inline float32 GetAngularDamping();
	inline void SetLinearDamping(float32 f);
	inline void SetAngularDamping(float32 f);
...
inline bodyUserData* b2Body::GetUserData()
{
	return &m_userData;
}

inline void b2Body::SetUserData(bodyUserData data)
{
	m_userData = data;
}
...
inline float32 b2Body::GetLinearDamping()
{
	return m_linearDamping;
}

inline float32 b2Body::GetAngularDamping()
{
	return m_angularDamping;
}

inline void b2Body::SetLinearDamping(float32 f)
{
	m_linearDamping = f;
}

inline void b2Body::SetAngularDamping(float32 f)
{
	m_angularDamping = f;
}
