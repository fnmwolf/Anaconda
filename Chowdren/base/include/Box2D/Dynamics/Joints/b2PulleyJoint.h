...
struct b2PulleyJointDef : public b2JointDef
{
	...
	int defSize(){return sizeof(b2PulleyJointDef);}

	b2Vec2 anchor1,anchor2;
	char local1,local2;
	b2Vec2 ganchor1,ganchor2;
	char glocal1,glocal2;
	float mlength1,mlength2;
	char mlocal1,mlocal2;
	float minLength;
	...
	void Initialize(b2Body* body1, b2Body* body2,
					...
					float32 ratio, float32 minLength);
...
public:
	...
	b2PulleyJoint(const b2PulleyJointDef* data, b2Settings* set);
