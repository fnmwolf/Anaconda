...
struct b2JointDef
{
	...
	virtual int defSize(){return sizeof(b2JointDef);}
...
public:
	...
	void SetUserData(jointUserData data);
...
protected:
	...
	static b2Joint* Create(const b2JointDef* def, b2BlockAllocator* allocator, b2Settings* set);
	static void Destroy(b2Joint* joint, b2BlockAllocator* allocator);

	b2Joint(const b2JointDef* def, b2Settings* set);
	virtual ~b2Joint() {}
...
inline jointUserData* b2Joint::GetUserData()
{
	return &m_userData;
}

inline void b2Joint::SetUserData(jointUserData data)
{
	m_userData = data;
}
