...
/// Concrete version of b2Contact which makes no guarantees
/// This is only needed for concave shapes
//class b2GenericContact : public b2Contact{
//	// TODO: Provide an implemenation, when someone actually needs this
//}

/// A contact which has at most one manifold, i.e. for convex-convex pairs
class b2SingleManifoldContact : public b2Contact{
public:
	b2SingleManifoldContact(b2Shape* shape1, b2Shape* shape2)
		:b2Contact(shape1,shape2)
	{
	}
...
/// A contact which has at most one contact point, e.g. for circle-convex pairs
class b2SinglePointContact : public b2Contact{
public:
	b2SinglePointContact(b2Shape* shape1, b2Shape* shape2)
		:b2Contact(shape1,shape2)
	{
	}
