	...
	const b2CircleShape* circle2, const b2XForm& xf2)
{
	...
	float32 r1 = circle1->GetRadius() - circle1->settings->b2_toiSlop;
	float32 r2 = circle2->GetRadius() - circle1->settings->b2_toiSlop;
	float32 r = r1 + r2;
	if (dSqr > r * r)
	{
	...
	const b2CircleShape* circle, const b2XForm& xf2)
{
	...
	float32 dSqr;
	float32 dLen;
	float32 r = circle->GetRadius() - circle->settings->b2_toiSlop;
