...
b2EdgeShape::b2EdgeShape(const b2Vec2& v1, const b2Vec2& v2, const b2ShapeDef* def, b2Settings* set)
: b2Shape(def, set)
{
	...
	m_coreV1 = -(set->b2_toiSlop) * (m_normal - m_direction) + m_v1;
	m_coreV2 = -(set->b2_toiSlop) * (m_normal + m_direction) + m_v2;
