...
struct b2ShapeDef
{
	...
	virtual int defSize(){return sizeof(b2ShapeDef);}
...
public:
	...
	shapeUserData* GetUserData();

	/// Set the user data. Use this to store your application specific data.
	void SetUserData(shapeUserData data);
...
protected:
	...
	static b2Shape* Create(const b2ShapeDef* def, b2BlockAllocator* allocator, b2Settings* set);
	static void Destroy(b2Shape* shape, b2BlockAllocator* allocator);

	b2Shape(const b2ShapeDef* def, b2Settings* set);
	virtual ~b2Shape();
...
inline shapeUserData* b2Shape::GetUserData()
{
	return &m_userData;
}

inline void b2Shape::SetUserData(shapeUserData data)
{
	m_userData = data;
}
