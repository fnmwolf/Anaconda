...
short WINAPI DLLExport CreateRunObject(LPRDATA rdPtr, LPEDATA edPtr, fpcob cobPtr)
{
	...
	RuntimeData * Data = (RuntimeData *)rhPtr->rh4.rh4Mv->mvGetExtUserData(rhPtr->rh4.rh4Mv->mvRunApp,hInstLib);
...
*/
	...
	rhPtr->rh4.rh4Mv->mvSetExtUserData(rhPtr->rh4.rh4Mv->mvRunApp,hInstLib,rdPtr->Data);
...
//	}
	...
	RuntimeData * Data=(RuntimeData *)mV->mvGetExtUserData(pApp,hInstLib);

	if(Data!=0)
	{
		delete Data;
		mV->mvSetExtUserData(pApp,hInstLib,0);
	}
}
